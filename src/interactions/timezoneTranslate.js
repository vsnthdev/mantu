...
function respond(command, message) {
    return __awaiter(this, void 0, void 0, function* () {
        if (command == 'time') {
            const timezone = (yield database_1.default.queries.getMember(message.author.id)).timezone;
            if (timezone !== null) {
        ...
        if (timeToTranslate.isValid() == true) {
            ...
            yield cleanup_1.forEach(members, (member) => __awaiter(this, void 0, void 0, function* () {
                const timezone = (yield database_1.default.queries.getMember(member.id)).timezone;
                if (timezone !== null) {
